...
var app = (function () {
    ...
    /* src\components\Oferta.svelte generated by Svelte v3.20.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(/*o*/ ctx[0]);
    			attr_dev(span, "class", "ProductCardstyle__DiscountPercent-sc-14yo7ej-3 gBbfsg svelte-jmhnby");
    			add_location(span, file, 21, 0, 415);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect1, file$1, 357, 22, 9233);
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(52:2) {#each items as item}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "card-details svelte-l5v19e");
    			add_location(div0, file$2, 49, 4, 817);
    			attr_dev(div1, "class", "card svelte-l5v19e");
    			add_location(div1, file$2, 48, 0, 793);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "circle svelte-xezpmr");
    			add_location(div, file$3, 160, 10, 4272);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "class", "svelte-xezpmr");
    			add_location(li, file$3, 114, 4, 2308);
    			attr_dev(ul, "class", "svelte-xezpmr");
    			add_location(ul, file$3, 113, 2, 2298);
    			attr_dev(header, "class", "svelte-xezpmr");
    			add_location(header, file$3, 112, 0, 2286);
    			...
    			attr_dev(path0, "class", "svelte-xezpmr");
    			add_location(path0, file$3, 131, 14, 2895);
    			attr_dev(g0, "data-name", "Group 16");
    			attr_dev(g0, "class", "svelte-xezpmr");
    			add_location(g0, file$3, 130, 12, 2855);
    			attr_dev(g1, "data-name", "Group 17");
    			attr_dev(g1, "transform", "translate(27.023 5.156)");
    			attr_dev(g1, "class", "svelte-xezpmr");
    			add_location(g1, file$3, 129, 10, 2781);
    			...
    			attr_dev(path1, "class", "svelte-xezpmr");
    			add_location(path1, file$3, 140, 14, 3575);
    			attr_dev(g2, "data-name", "Group 18");
    			attr_dev(g2, "class", "svelte-xezpmr");
    			add_location(g2, file$3, 139, 12, 3535);
    			attr_dev(g3, "data-name", "Group 19");
    			attr_dev(g3, "transform", "translate(30.274 2)");
    			attr_dev(g3, "class", "svelte-xezpmr");
    			add_location(g3, file$3, 138, 10, 3465);
    			attr_dev(g4, "data-name", "Group 2704");
    			attr_dev(g4, "transform", "translate(-27.023 -2)");
    			attr_dev(g4, "class", "svelte-xezpmr");
    			add_location(g4, file$3, 128, 8, 2709);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "width", "12.686");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "viewBox", "0 0 12.686 16");
    			attr_dev(svg, "class", "svelte-xezpmr");
    			add_location(svg, file$3, 123, 6, 2572);
    			attr_dev(span0, "class", "svelte-xezpmr");
    			add_location(span0, file$3, 122, 4, 2558);
    			set_style(span1, "vertical-align", "inherit");
    			attr_dev(span1, "class", "svelte-xezpmr");
    			add_location(span1, file$3, 152, 6, 3976);
    			set_style(span2, "vertical-align", "inherit");
    			attr_dev(span2, "class", "svelte-xezpmr");
    			add_location(span2, file$3, 151, 4, 3929);
    			set_style(span3, "vertical-align", "inherit");
    			attr_dev(span3, "class", "svelte-xezpmr");
    			add_location(span3, file$3, 158, 8, 4193);
    			set_style(span4, "vertical-align", "inherit");
    			attr_dev(span4, "class", "svelte-xezpmr");
    			add_location(span4, file$3, 157, 6, 4144);
    			attr_dev(span5, "class", "CartPopupstyle__PriceBoxAlt-sc-67tc19-6 iZKyqx svelte-xezpmr");
    			add_location(span5, file$3, 154, 4, 4051);
    			attr_dev(span6, "class", "CartPopupstyle__TotalItems-sc-67tc19-5 bMppaE svelte-xezpmr");
    			add_location(span6, file$3, 121, 2, 2492);
    			attr_dev(button, "class", "CartPopupstyle__CartPopupBoxButton-sc-67tc19-4 hQDCQX product-cart svelte-xezpmr");
    			add_location(button, file$3, 118, 0, 2375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img_1.src !== (img_1_src_value = `img/${/*img*/ ctx[4]}`)) attr_dev(img_1, "src", img_1_src_value);
    			attr_dev(img_1, "alt", /*name*/ ctx[2]);
    			attr_dev(img_1, "class", "svelte-dagden");
    			add_location(img_1, file$4, 383, 2, 7863);
    			attr_dev(h3, "class", "title svelte-dagden");
    			add_location(h3, file$4, 385, 4, 7938);
    			attr_dev(p0, "class", "price svelte-dagden");
    			add_location(p0, file$4, 386, 4, 7973);
    			attr_dev(p1, "class", "price svelte-dagden");
    			add_location(p1, file$4, 387, 4, 8014);
    			attr_dev(rect0, "data-name", "Rectangle 522");
    			attr_dev(rect0, "width", "12");
    			attr_dev(rect0, "height", "2");
    			attr_dev(rect0, "rx", "1");
    			attr_dev(rect0, "fill", "currentColor");
    			attr_dev(rect0, "class", "svelte-dagden");
    			add_location(rect0, file$4, 402, 20, 8597);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "width", "12px");
    			attr_dev(svg0, "height", "2px");
    			attr_dev(svg0, "viewBox", "0 0 12 2");
    			attr_dev(svg0, "class", "svelte-dagden");
    			add_location(svg0, file$4, 397, 18, 8406);
    			attr_dev(button0, "class", " add  Counterstyle__CounterButton-sc-14ahato-1 bPmfin svelte-dagden");
    			add_location(button0, file$4, 394, 16, 8248);
    			attr_dev(span, "class", "Counterstyle__CounterValue-sc-14ahato-2 dMHyRK svelte-dagden");
    			add_location(span, file$4, 410, 16, 8866);
    			attr_dev(rect1, "data-name", "Rectangle 520");
    			attr_dev(rect1, "width", "12");
    			attr_dev(rect1, "height", "2");
    			attr_dev(rect1, "rx", "1");
    			attr_dev(rect1, "transform", "translate(1367 195)");
    			attr_dev(rect1, "fill", "currentColor");
    			attr_dev(rect1, "class", "svelte-dagden");
    			add_location(rect1, file$4, 425, 22, 9511);
    			attr_dev(rect2, "data-name", "Rectangle 521");
    			attr_dev(rect2, "width", "12");
    			attr_dev(rect2, "height", "2");
    			attr_dev(rect2, "rx", "1");
    			attr_dev(rect2, "transform", "translate(1374 190) rotate(90)");
    			attr_dev(rect2, "fill", "currentColor");
    			attr_dev(rect2, "class", "svelte-dagden");
    			add_location(rect2, file$4, 432, 22, 9800);
    			attr_dev(g, "id", "Group_3351");
    			attr_dev(g, "data-name", "Group 3351");
    			attr_dev(g, "transform", "translate(-1367 -190)");
    			attr_dev(g, "class", "svelte-dagden");
    			add_location(g, file$4, 421, 20, 9342);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "width", "12px");
    			attr_dev(svg1, "height", "12px");
    			attr_dev(svg1, "viewBox", "0 0 12 12");
    			attr_dev(svg1, "class", "svelte-dagden");
    			add_location(svg1, file$4, 416, 18, 9149);
    			attr_dev(button1, "class", "Counterstyle__CounterButton-sc-14ahato-1 bPmfin svelte-dagden");
    			add_location(button1, file$4, 413, 16, 8997);
    			attr_dev(div0, "class", "Counterstyle__CounterBox-sc-14ahato-0 fmEddu svelte-dagden");
    			add_location(div0, file$4, 390, 12, 8095);
    			attr_dev(object, "aria-label", "remove");
    			attr_dev(object, "type", "image/svg+xml");
    			attr_dev(object, "data", "img/svg/cancel.svg");
    			attr_dev(object, "class", "svelte-dagden");
    			add_location(object, file$4, 445, 6, 10240);
    			attr_dev(button2, "class", "remove svelte-dagden");
    			add_location(button2, file$4, 444, 6, 10187);
    			attr_dev(div1, "class", "count svelte-dagden");
    			add_location(div1, file$4, 389, 4, 8062);
    			attr_dev(div2, "class", "item-meta-data svelte-dagden");
    			add_location(div2, file$4, 384, 2, 7904);
    			attr_dev(div3, "class", "item-grid svelte-dagden");
    			add_location(div3, file$4, 382, 0, 7836);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
